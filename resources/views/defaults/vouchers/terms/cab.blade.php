    ...
    <div class="modal-dialog modal-cab">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Cab Voucher (Terms & Conditions)</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="cabForm" action="{{ route('voucher.cab.terms.save') }}">
                    @csrf
...
<div class="modal fade" id="modal-edit-cab">
    <div class="modal-dialog modal-edit-cab">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Cab Voucher (Terms & Conditions)</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="updatecabForm" action="{{ route('voucher.cab.terms.update') }}">
                    @csrf
