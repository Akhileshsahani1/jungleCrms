...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Voucher Terms & Conditions</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="card card-dark card-tabs">
                ...
                <div class="card-body">
                    <div class="tab-content" id="custom-tabs-one-tabContent">
                        ...
                        <div class="col-sm-12">
                            <strong>Package Voucher</strong>
                            <span class="float-right"><a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal"
                                    data-target="#modal-package">Add</a></span>
                        </div>
                        <div class="col-sm-12 mt-5">
                            <h4 class="text-info text-center">Gir</h4>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th style="width: 10px">#</th>
                                ...
                                <tbody>
                                    @foreach ($package_gir_terms as $gir_term)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $gir_term->content }}</td>
                                            <td>Gir</td>
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    data-filter="{{ $gir_term->filter }}" data-id="{{ $gir_term->id }}"> <i class="fas fa-pen"></i>
                                                    </a>
                                                    <button type="button" onclick="confirmDelete({{ $gir_term->id }})"
                                                        class="btn btn-danger"><i class="fas fa-trash"></i>
                                                    </button>
                        ...
                        <div class="col-sm-12 mt-5">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($package_jim_terms as $jim_term)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $jim_term->content }}</td>
                                            <td>Jim Corbett</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="javascript:void(0)" class="btn btn-warning edit-package" data-toggle="modal" data-target="#modal-edit-package" data-content="{{ $jim_term->content }}"
                                                    data-filter="{{ $jim_term->filter }}" data-id="{{ $jim_term->id }}"> <i class="fas fa-pen"></i>
                                                    </a>
                                                    <button type="button" onclick="confirmDelete({{ $jim_term->id }})"
                                                        class="btn btn-danger"><i class="fas fa-trash"></i>
                                                    </button>
                        ...
                        <div class="col-sm-12 mt-5">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($package_ran_terms as $ran_term)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $ran_term->content }}</td>
                                            <td>Ranthambore</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="javascript:void(0)" class="btn btn-warning edit-package" data-toggle="modal" data-target="#modal-edit-package" data-content="{{ $ran_term->content }}"
                                                    data-filter="{{ $ran_term->filter }}" data-id="{{ $ran_term->id }}"> <i class="fas fa-pen"></i>
                                                    </a>
                                                    <button type="button" onclick="confirmDelete({{ $ran_term->id }})"
                                                        class="btn btn-danger"><i class="fas fa-trash"></i>
                                                    </button>
                         ...
                         <div class="col-sm-12 mt-5">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($package_tadoba_terms as $ran_term)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $ran_term->content }}</td>
                                            <td>Tadoba</td>
    ...
    @include('defaults.vouchers.terms.cab')
    @include('defaults.vouchers.terms.hotel')
    @include('defaults.vouchers.terms.safari')
    @include('defaults.vouchers.terms.tour')
    @include('defaults.vouchers.terms.package')
@endsection
@push('scripts')
...
<script>
    $(".edit-package").click(function () {
            ...
            $('#package_term_id').val(id);
             $("#edit_package_filter").val(filter).change();
        });
</script>
