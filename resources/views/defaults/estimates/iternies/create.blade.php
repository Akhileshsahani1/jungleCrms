...
@section('title', 'Create Iternaries')
@section('head')
...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Create Iternaries</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('iternary.update',$id) }}" id="companyForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <table id="option" class="table table-striped">
                            <tbody>
                                    <tr id="item-option-row0">
                                        <td style="width:350px"><input type="text" name="item[0][title]"
                                                placeholder="Iternary Title" class="form-control" id="particular0"  required></td>
                                        <td>
                                        <textarea name="item[0][text]" class="form-control rate"
                                                id="rate0" placeholder="Iternary text" rows="3" required></textarea>
                                        </td>
