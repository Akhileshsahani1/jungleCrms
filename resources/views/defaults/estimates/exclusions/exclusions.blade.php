...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Exclusions</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="tab-content" id="custom-tabs-one-tabContent">
                        <div class="tab-pane fade show active" id="custom-tabs-one-cab" role="tabpanel"
                            ...
                            <div class="col-sm-12 mt-5">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($cab_exclusions as $term)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <form id='delete-form{{ $term->id }}' action='{{route('exclusions.destroy', $term->id)}}' method='POST'>
                        ...
                        <div class="tab-pane fade" id="custom-tabs-one-hotel" role="tabpanel"
                            ...
                            <div class="col-sm-12">
                                <strong>Hotel Exclusions</strong>
                                <span class="float-right"><a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal"
                            ...
                            <div class="col-sm-12 mt-5">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($hotel_normal_exclusions as $term)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $term->content }}</td>
                            ...
                            <div class="col-sm-12 mt-5">
                                <h4 class="text-info text-center">Weekend Exclusions</h4>
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th style="width: 10px">#</th>
                                    ...
                                    <tbody>
                                        @foreach ($hotel_weekend_exclusions as $term)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $term->content }}</td>
                                                <td>{{ ucfirst($term->filter) }}</td>
                            ...
                            <div class="col-sm-12 mt-5">
                                <h4 class="text-info text-center">Festival Exclusions</h4>
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th style="width: 10px">#</th>
                                    ...
                                    <tbody>
                                        @foreach ($hotel_festival_exclusions as $term)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $term->content }}</td>
                                                <td>{{ ucfirst($term->filter) }}</td>
                        ...
                        <div class="tab-pane fade" id="custom-tabs-one-safari" role="tabpanel"
                            ...
                            <div class="col-sm-12">
                                <strong>Safari Exclusions</strong>
                                <span class="float-right"><a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal"
                                        data-target="#modal-safari">Add</a></span>
                            </div>
                            <div class="col-sm-12 mt-5">
                                <h4 class="text-info text-center">Gir Exclusions</h4>
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th style="width: 10px">#</th>
                                    ...
                                    <tbody>
                                        @foreach ($safari_gir_exclusions as $term)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $term->content }}</td>
                                                <td>{{ ucfirst($term->filter) }}</td>
                            ...
                            <div class="col-sm-12 mt-5">
                                <h4 class="text-info text-center">Jim Corbett Exclusions</h4>
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th style="width: 10px">#</th>
                                    ...
                                    <tbody>
                                        @foreach ($safari_jim_exclusions as $term)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $term->content }}</td>
                                                <td>Jim Corbett</td>
                            ...
                            <div class="col-sm-12 mt-5">
                                <h4 class="text-info text-center">Ranthambore Exclusions</h4>
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th style="width: 10px">#</th>
                                    ...
                                    <tbody>
                                        @foreach ($safari_ran_exclusions as $term)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $term->content }}</td>
                                                <td>Ranthambore</td>
                             ...
                             <div class="col-sm-12 mt-5">
                                <h4 class="text-info text-center">Tadoba Exclusions</h4>
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th style="width: 10px">#</th>
                                    ...
                                    <tbody>
                                        @foreach ($safari_tadoba_exclusions as $term)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $term->content }}</td>
                                                <td>Tadoba</td>
                        ...
                        <div class="tab-pane fade" id="custom-tabs-one-tour" role="tabpanel"
                            ...
                            <div class="col-sm-12 mt-5">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($tour_exclusions as $term)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $term->content }}</td>
                                                <td>
                        ...
                        <div class="tab-pane fade" id="custom-tabs-one-package" role="tabpanel"
                            ...
                            <div class="col-sm-12 mt-5">
                                 @foreach ($package_exclusions as $destination)
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                          @if($destination->exclusions)
                                            @foreach($destination->exclusions as $term)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $term->content }}</td>
                                                <td>
    ...
    @include('defaults.estimates.exclusions.cab')
    @include('defaults.estimates.exclusions.hotel')
    @include('defaults.estimates.exclusions.safari')
    @include('defaults.estimates.exclusions.tour')
    @include('defaults.estimates.exclusions.package')
@endsection
@push('scripts')
