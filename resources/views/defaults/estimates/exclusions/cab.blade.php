    ...
    <div class="modal-dialog modal-cab">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Cab Exclusion</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="cabForm" action="{{ route('cab.exclusions.save') }}">
                    @csrf
...
<div class="modal fade" id="modal-edit-cab">
    <div class="modal-dialog modal-edit-cab">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Cab Inclusion</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="updatecabForm" action="{{ route('cab.exclusions.update') }}">
                    @csrf
