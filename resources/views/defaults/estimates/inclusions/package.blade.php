    ...
    <div class="modal-dialog modal-package">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Package Inclusion</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="packageForm" action="{{ route('package.inclusions.save') }}">
                    @csrf
...
<div class="modal fade" id="modal-edit-package">
    <div class="modal-dialog modal-edit-package">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Package Inclusion</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="updatepackageForm" action="{{ route('package.inclusions.update') }}">
                    @csrf
