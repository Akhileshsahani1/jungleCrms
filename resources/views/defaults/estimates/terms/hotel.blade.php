    ...
    <div class="modal-dialog modal-hotel">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Hotel Estimate (Terms & Conditions)</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="hotelForm" action="{{ route('hotel.terms.save') }}">
                    @csrf
...
<div class="modal fade" id="modal-edit-hotel">
    <div class="modal-dialog modal-edit-hotel">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Hotel Estimate (Terms & Conditions)</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="updatehotelForm" action="{{ route('hotel.terms.update') }}">
                    @csrf
