    ...
    <div class="modal-dialog modal-tour">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Tour Estimate (Terms & Conditions)</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="tourForm" action="{{ route('tour.terms.save') }}">
                    @csrf
...
<div class="modal fade" id="modal-edit-tour">
    <div class="modal-dialog modal-edit-tour">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Tour Estimate (Terms & Conditions)</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="updatetourForm" action="{{ route('tour.terms.update') }}">
                    @csrf
