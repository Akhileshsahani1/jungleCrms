    ...
    <div class="modal-dialog modal-safari">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Safari Estimate (Terms & Conditions)</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="safariForm" action="{{ route('safari.terms.save') }}">
                    @csrf
...
<div class="modal fade" id="modal-edit-safari">
    <div class="modal-dialog modal-edit-safari">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Safari Estimate (Terms & Conditions)</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" id="updatesafariForm" action="{{ route('safari.terms.update') }}">
                    @csrf
