            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <div class="btn-group">
                        ...
                        <a href="{{ route('reports_estimates.index') }}" class="btn btn-secondary ml-2" id="reset-filter"><i class="fa fa-undo"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                @include('reports.estimatefilter')
            </div>
            <div class="card-body">
                ...
                <table id="estimateDataTable" class="table table-bordered table-striped">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th></th>
                            <th></th>
                            <th>Total Number of Estimates Created</th>
