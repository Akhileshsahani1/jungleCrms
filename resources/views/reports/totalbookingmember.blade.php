            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <div class="btn-group">
                        ...
                        <a href="{{ route('reports_memberbooking.index') }}" class="btn btn-secondary ml-1" id="reset-filter">
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                @include('reports.bookingtotalmemberfilter')
            </div>
            <div class="card-body">
                @if(count($bookings) > 0)
