...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="nav-icon fas fa-check-circle"></i> Packages</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <div class="btn-group">
                        <button type="submit" class="btn btn-info" form="form-filter"><i class="fa fa-filter"></i></button>
                        <a href="{{ route('reports_packages.index') }}" class="btn btn-secondary ml-1" id="reset-filter"><i
                ...
                <table id="bookings" class="table table-bordered table-striped">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th></th>
                            <th></th>
                            <th>Total Number of Packages Created</th>
