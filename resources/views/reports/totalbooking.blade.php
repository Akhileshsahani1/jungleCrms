            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <div class="btn-group">
                        ...
                        <a href="{{ route('reports_totalbooking.index') }}" class="btn btn-secondary ml-1" id="reset-filter">
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                @include('reports.bookingtotalfilter')
            </div>
            <div class="card-body">
                @if(count($bookings) > 0)
                <table id="bookings" class="table table-bordered table-striped">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><i class="fa fa-inr"></i> {{ number_format($totalBookingUnPaidAmount,2) }}</th>
                            <th>Total Paid Amount</th>
                            <th><i class="fa fa-inr"></i> {{ number_format($totalBookingPaidAmount,2) }}</th>
                            <th>Total Amount of Bookings</th>
                            <th><i class="fa fa-inr"></i> {{ number_format($totalBookingAmount,2) }}</th>
