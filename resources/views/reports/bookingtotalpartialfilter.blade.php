<form id="form-filter" class="inline-form" action="{{ route('reports_partialbooking.index') }}">
    <div class="form-row mb-2">

        <div class="col">
            <label for="filter_name">Date Range</label>
            <input type="text" name="filter_daterange" class="form-control" value="{{ $filter_daterange }}" />
        </div>
        ...
        <div class="col">
            ...
            <select name="filter_sanctuary" class="form-control">
                ...
                <option value="ranthambore" {{ $filter_sanctuary == 'Ranthambore' ? 'selected' : '' }}>Ranthambore</option>
