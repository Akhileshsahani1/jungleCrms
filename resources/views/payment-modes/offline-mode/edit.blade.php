...
@section('title', 'Edit Offline Mode')
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Offline Mode</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <form id="PaymentModeForm" method="POST" action="{{ route('offline-mode.update', $mode->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="account_holder_name" name="account_holder_name" placeholder="Enter Account Holder Name"
                            value="{{ old('account_holder_name', $mode->details['account_holder_name']) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="account_number" name="account_number" placeholder="Enter Account Number"
                            value="{{ old('account_number', $mode->details['account_number']) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ifsc_code" name="ifsc_code" placeholder="Enter IFSC Code"
                            value="{{ old('ifsc_code', $mode->details['ifsc_code']) }}">
                        @error('ifsc_code')
                            <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="account_type" name="account_type">
                                ...
                                <option value="current" @if($mode->details['account_type'] == 'current') selected @endif>Current</option>
                                <option value="savings" @if($mode->details['account_type'] == 'savings') selected @endif>Saving</option>
                        </select>
                        @error('account_type')
                            <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bank_name" name="bank_name" placeholder="Enter Bank Name"
                            value="{{ old('bank_name', $mode->details['bank_name']) }}">
                        @error('bank_name')
                            <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
