...
@section('title', 'Edit Razorpay Mode')
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Razorpay Mode</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <form id="PaymentModeForm" method="POST" action="{{ route('razorpay-mode.update', $mode->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="razorpay_key" name="razorpay_key" placeholder="Enter Razorpay Key"
                            value="{{ old('razorpay_key', $mode->details['razorpay_key']) }}">
                        @error('razorpay_key')
                            <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="razorpay_secret_key" name="razorpay_secret_key" placeholder="Enter Razorpay Secret Key"
                            value="{{ old('razorpay_secret_key', $mode->details['razorpay_secret_key']) }}">
