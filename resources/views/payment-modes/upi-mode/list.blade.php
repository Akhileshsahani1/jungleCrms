...
@section('title', 'Payment Mode| UPI')
@section('head')
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">UPI Mode</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-header">
        <div class="card-tools">
          <a href="{{ route('upi-mode.create') }}" class="btn btn-success btn-block">
        ...
        <table id="dataTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                        <a href="{{ route('upi-mode.edit', $mode->id) }}" class="btn btn-warning"> <i class="fas fa-pen"></i> </a>
                        <button type="button" onclick="confirmDelete({{$mode->id}})" class="btn btn-danger"><i class="fas fa-trash"></i> </button>
                        <form id='delete-form{{$mode->id}}' action='{{route('upi-mode.destroy', $mode->id)}}' method='POST'>
...
$("input[data-bootstrap-switch]").bootstrapSwitch();
    ...
    function changeStatus(event, id) {
        ...
        var url = '{{ route("upi-mode.show", ":id") }}';
