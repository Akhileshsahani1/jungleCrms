...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-globe-asia"></i> Create Package Booking</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('bookings.index') }}">Bookings</a></li>
                        <li class="breadcrumb-item active">Create Package Booking</li>
                    </ol>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
       ...
       function addSafari() {
           ...
           if (sanctuary == 'gir') {
            ...
            html += '<option value="Car">Bus</option>';
            html += '</select>';
            html += '</div>';
            html += '<div class="form-group col-sm-4">';
    ...
    if (sanctuary == 'tadoba') {
        ...
        html +='<div class="form-group col-sm-4">';
        html +='<label for="mode' + safari_row + '">Mode of Vehicle</label>';
        html +='<select id="mode' + safari_row + '" class="form-control tadoba" name="safari[' + safari_row + '][mode]" onchange="javascript: loadtadobaCorbettSafariPackageTimings(' + safari_row + ', this.options[this.selectedIndex].value);" required>';
        html +='<option value="" selected>Select Mode of Vehicle</option>';
        html +='<option value="Jeep">Jeep</option>';
        html +='<option value="Canter">Canter</option>';
        html +='</select>';
        ...
        html +='<div class="form-group col-sm-4">';
        html +='<label for="vendor' + safari_row + '">Choose Vendor</label>';
        html +='<select id="vendor' + safari_row + '" class="form-control tadoba" name="safari[' + safari_row + '][vendor]" required>';
        html +='@foreach ($vendors as $vendor)';
        html +='@if($vendor->sanctuary == "tadoba")';
        html +='<option value="{{ $vendor->id }}" @if($vendor->default == "yes") selected @endif>{{ $vendor-> name}} ({{ $vendor-> phone}})</option>';
        html +='@else';
        html +='@continue;';
        html +='@endif';
        ...
        html +='<div class="form-group col-sm-4">';
        html +='<label for="safari_due_amount' + safari_row + '">Safari Due Amount (₹)</label>';
        html +='<input type="number" id="safari_due_amount' + safari_row + '" class="form-control tadoba" placeholder="Safari Due Amount" name="safari[' + safari_row + '][safari_due_amount]" value="0" required>';
        html +='</div>';
        html +='<div class="form-group col-sm-12">';
        html +='<label for="note' + safari_row + '">Safari Note</label>';
