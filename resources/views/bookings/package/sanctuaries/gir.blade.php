...
<div class="card" id="safaris{{ $key }}">
    ...
    <div class="card-body">
        ...
        <div class="form-group col-sm-4">
            ...
            <select id="vendor{{ $key }}" class="form-control gir" name="safari[{{ $key }}][vendor]" required>
        ...
        <div class="form-group col-sm-12">
            ...
            <input type="number" id="safari_due_amount{{ $key }}" class="form-control gir" placeholder="Safari Due Amount"
                name="safari[{{ $key }}][safari_due_amount]" value="{{ $safari->safari_due_amount ?? 0 }}" required>
        </div>

        <div class="form-group col-sm-12">
            <label for="note{{ $key }}">Safari Note</label>
            <textarea class="form-control summernote gir" id="note{{ $key }}" name="safari[{{ $key }}][note]">{{ $safari->note }}</textarea>
        </div>
        </div>
    </div>
</div>
...
<div class="card" id="safaris0">
    ...
    <div class="card-body">
        ...
        <div class="form-group col-sm-4">
            ...
            <select id="vendor0" class="form-control gir" name="safari[0][vendor]" required>
                @foreach ($vendors as $vendor)
                @if($vendor->sanctuary == 'gir')
        ...
        <div class="form-group col-sm-12">
            ...
            <input type="number" id="safari_due_amount0" class="form-control gir" placeholder="Safari Due Amount"
                name="safari[0][safari_due_amount]" value="0" required>
        </div>
        <div class="form-group col-sm-12">
            <label for="note0">Safari Note</label>
            <textarea class="form-control summernote gir" id="note0" name="safari[0][note]"></textarea>
        </div>
        </div>
    </div>
</div>
