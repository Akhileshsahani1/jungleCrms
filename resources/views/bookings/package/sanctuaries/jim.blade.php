    ...
    <div class="card-body">
        <div class="row">
            <div class="form-group col-sm-4">
                ...
                <select id="mode{{ $key }}" class="form-control jim" name="safari[{{ $key }}][mode]" onchange="javascript: loadJimCorbettSafariPackageTimings({{ $key }}, this.options[this.selectedIndex].value);" required>
            ...
            <div class="form-group col-sm-12">
                ...
                <textarea class="form-control summernote jim" id="note{{ $key }}" name="safari[{{ $key }}][note]">{{ $safari->note }}</textarea>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="form-group col-sm-4">
                ...
                <select id="mode0" class="form-control jim" name="safari[0][mode]" onchange="javascript: loadJimCorbettSafariPackageTimings(0, this.options[this.selectedIndex].value);" required>
                    <option value="" selected>Select Mode of Vehicle</option>
            ...
            <div class="form-group col-sm-12">
                ...
                <textarea class="form-control summernote jim" id="note0" name="safari[0][note]"></textarea>
            </div>
        </div>
    </div>
</div>
