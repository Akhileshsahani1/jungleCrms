                            ...
                            <div class="text-center m-2">
                                @if( $cab->status == 0)
                                 @if($booking->cancellationRequest)
                                    @if($booking->cancellationRequest->status)
                                        ...
                                        <table class="table table-sm">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Contact Email</td>
                                                    <td class="text-right">
                                                        {{ isset($hotel->email) ? $hotel->email : 'N/A' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Status</td>
                                                    <td class="text-right">
                                                        {{ $hotel->status == 1 ? 'Enabled' : 'Disabled' }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item  @if ($loop->first) active @endif">
                                                <img class="d-block w-100" src="{{ $image->path }}" alt="{{ $image->image }}" width="514" height="343">
                                            </div>
                                            @endforeach
                                        </div>
                ...
                <div class="card-body">
                    <table class="table table-sm">
                        <tbody>
                            ...
                            @if (in_array($safari->sanctuary, ['jim','ranthambore','tadoba']))
                            <tr>
                                <td>Safari Area</td>
                                <td class="text-right">{{ $safari->area }}</td>
                            </tr>
                            @endif
                            @if (in_array($safari->sanctuary, ['gir','ranthambore']))
                            <tr>
                                <td>Safari Zone</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="{{ route('package-booking.voucher', $booking->id) }}" class="btn btn-warning btn-block">Download Voucher</a>
                ...
                @else
                <a href="{{ route('package-booking.voucher', $booking->id) }}" class="btn btn-info btn-block">Generate Voucher</a>
                @endif
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12 mb-4">
                            ...
                            <span class="float-right">
                                ...
                                <div class="btn-group">
                                    <a href="{{ asset('storage/uploads/bookings/permits/package/' . $booking->id . '/' . $permit->permit) }}" download class="btn btn-dark" data-toggle="tooltip" title="Download Permit">
