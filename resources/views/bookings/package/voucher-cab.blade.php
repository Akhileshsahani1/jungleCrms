        ...
        <div class="sub-page">
            ...
            <div style="width:100%">
                <div style="width:50%; float:left;">
                    S.No. : JSI-CV-{{ $cab->id }}-{{ $booking->id + 1000 }}
                </div>
                    ...
                    <table class="table table-billing-details table-condensed">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($cab->start_date)->format('d-m-Y') }}</td>
                            </tr>
                            <tr>
                                <td class="text-left"> Trip End On:</td>
                                <td>{{ \Carbon\Carbon::parse($cab->end_date)->format('d-m-Y') }}</td>
                            </tr>
                            <tr>
                                <td class="text-left">Pickup Time:</td>
                                <td>{{ \Carbon\Carbon::parse($cab->pickup_time)->format('g:i A') }}</td>
                            </tr>
            ...
            <div style="width:100%; text-align: center;">
                Cab Driver : Mr. {{ $cab->vendor_name }} ({{ $cab->vendor_mobile }}).
            ...
            @if ($cab->cab_due_amount > 0)                
                <div style="width:100%; margin:5px; text-align: center;color:red;">
                    You have to Pay INR {{ $cab->cab_due_amount }} to the Cab Driver before Cab start.
                </div>
            @endif                        
