    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a href="{{ route('download.hotel.images', $hotel->id) }}" class="btn btn-info" data-toggle="tooltip" title="Download Images"> <i class="fas fa-download"></i> </a>
                <div class="btn-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="{{ route('tour-booking.voucher', $booking->id) }}" class="btn btn-warning btn-block">Download Voucher</a>
                ...
                @else
                <a href="{{ route('tour-booking.voucher', $booking->id) }}" class="btn btn-info btn-block">Generate Voucher</a>
                @endif
            </div>
