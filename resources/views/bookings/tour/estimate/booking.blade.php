        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('tour-booking.store') }}" id="tourForm" enctype="multipart/form-data">
                ...
                <div class="card-body mt-2">
                    <div class="row">
                        @include('bookings.tour.estimate.form')
                    </div>
                </div>
            </form>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        <script>
            ...
            var hotel_room = '{{ $booking->option_selected->room_id}}';
            var hotel = '{{ $booking->option_selected->hotel_id}}';
            var service = '{{ $booking->option_selected->service_id}}';
            $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: "{{ route('get.rooms') }}",
