        ...
        <div class="sub-page">
            <header>
                ...
                <div class="float-right">
                    <h4 class="estimate-heading">Tour Booking Voucher</h4>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <p>
                        ...
                        Thank you for using Jungle Safari India to book your Tour. For your reference, your <strong> Tour Booking ID: JSI-TB-{{ $booking->id + 1000 }}</strong>. Kindly
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <strong>Meals:
                                    </strong>{{ \App\Models\HotelRoomService::find($booking->hotel->service_id)->service }}
                                    <br>
                                </td>
