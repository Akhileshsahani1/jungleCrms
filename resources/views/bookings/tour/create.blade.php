...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-globe-asia"></i> Create Tour Booking</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('bookings.index') }}">Bookings</a></li>
                        <li class="breadcrumb-item active">Create Tour Booking</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card">
            ...
            <form method="POST" action="{{ route('tour-booking.store') }}" id="tourForm" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
        ...
        function loadSafariTimings(safari_row, listindex)
           {
               ...
               case "Kankai Nature Safari" :
                   document.getElementById("time"+safari_row).options[0]=new Option("Select Time","");
                   document.getElementById("time"+safari_row).options[1]=new Option("6:00 AM - 11:00 PM", "6:00 AM - 11:00 PM");
