...
@section('title', 'Edit Safari Booking')
@section('head')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fab fa-safari"></i> Edit Safari Booking</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('bookings.index') }}">Bookings</a></li>
                        <li class="breadcrumb-item active">Edit Safari Booking</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <section class="content">
            <div class="card">
                ...
                <form method="POST" action="{{ route('safari-booking.update', $booking->id) }}" id="safariForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
    ...
    <script>
        ...
        function addCustomer() {
            if (customer_option_row < 50) {
                ...
                html += '</td>';
                html += '<td>';
                html += '<select name="customer[' + customer_option_row +'][nationality]" class="form-control" id="nationality' + customer_option_row +'" required>';
