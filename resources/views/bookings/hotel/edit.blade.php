...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-hotel"></i> Edit Hotel Booking</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('bookings.index') }}">Bookings</a></li>
                        <li class="breadcrumb-item active">Edit Hotel Booking</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card">
            ...
            <form method="POST" action="{{ route('hotel-booking.update', $booking->id) }}" id="hotelForm">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
