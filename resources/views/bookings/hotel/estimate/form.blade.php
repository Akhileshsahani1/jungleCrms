            ...
            <div class="row">
                <div class="form-group col-sm-4">
                    ...
                    <input type="number" id="adult" class="form-control guest" placeholder="No of Adults" name="adult"
                        value="{{ old('adult', isset($booking) ? $booking->hotel->adult : '0') }}">
                    @error('adult')
                ...
                <div class="form-group col-sm-4">
                    ...
                    <input type="number" id="child" class="form-control guest" placeholder="No of Children" name="child"
                        value="{{ old('child', isset($booking) ? $booking->hotel->child : '0') }}">
                    @error('child')
                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group col-sm-4">
                    ...
                    <select class="form-control" name="hotel" id="hotel_id"
                        onchange="getRooms(this.value)">
                        <option></option>
                        @foreach ($hotels as $hotel)
                            <option value="{{ $hotel->id }}" {{ old('hotel', isset($booking) ? $booking->option_selected->hotel_id : '') == $hotel->id ? 'selected' : '' }}> {{ $hotel->name }}</option>
                        @endforeach
                    </select>
                    @error('hotel')
                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                ...
                <div class="form-group col-sm-4">
                 ...
                 <div class="form-group col-sm-4">
                    ...
                    <input type="number" id="hotel_due_amount" class="form-control" placeholder="hotel Due Amount" name="hotel_due_amount"
                ...
                <div class="form-group col-sm-12">
                    ...
                    <textarea class="form-control summernote" id="note"
                        name="note">{{ old('note', isset($booking) ? $booking->hotel->note : '') }}</textarea>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody>
                        <tr id="item-option-row0">
                            ...
                            <td><input type="number" name="item[0][amount]" placeholder="Amount"
                                    class="form-control amount" id="amount0" value="{{ old('amount', isset($booking) ? $booking->option_selected->total : '') ?  $booking->option_selected->total : '0' }}" required></td>
                            <td><input type="number" name="item[0][rate]" placeholder="Rate" class="form-control rate"
                                    id="rate0" value="0" required></td>
