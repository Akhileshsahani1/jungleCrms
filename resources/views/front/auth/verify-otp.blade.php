...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="alert alert-success" role="alert">
            ...
            <strong>OTP has been sent successfully. {{ Session::get('otp') }}</strong>
        </div>
        ...
        <div class="card card-outline card-success">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('verify-customer-otp') }}">
                    @csrf
                    <div class="input-group mb-3">
                        Enter the code we just send on your mobile phone {{ $user->mobile }}.
                        <input type="hidden" class="form-control" name="phone" value="{{ $user->mobile }}">
                    </div>
