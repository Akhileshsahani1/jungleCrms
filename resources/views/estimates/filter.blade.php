<form id="form-filter" class="inline-form" action="{{ route('estimates.index') }}">
    <div class="form-row">
        <div class="col-3">
        ...
        <div class="col-2">
            <label class="col-form-label" for="">Estimate Type</label>
             <select id="input" class="form-control form-control-sm" name="filter_estimate_type">
                  <option value="">All</option>
    ...
    <div class="col-2">
        <label for="website" class="col-form-label">Website</label>
           <select class="form-control form-control-sm" name="filter_website">
            ...
            <option @if (@$filter_website == 'SMO') selected @endif value="SMO">SMO</option>
           </select>
    </div>
    <div class="col-2">
