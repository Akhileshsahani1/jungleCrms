...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-globe-asia"></i> Tour Estimate</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('leads.show', $lead->id) }}">Lead</a></li>
                        <li class="breadcrumb-item active">Tour Estimate</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card">
            ...
            <form method="POST" action="{{ route('tour-estimate.store') }}" id="tourForm">
                @csrf
