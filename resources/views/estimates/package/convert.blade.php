...
@section('title', 'Package Estimate')
@section('head')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-globe-asia"></i> Package Estimate</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('leads.show', $lead->id) }}">Lead</a></li>
                        <li class="breadcrumb-item active">Package Estimate</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card">
            ...
            <form method="POST" action="{{ route('package-estimate.store') }}" id="tourForm">
                @csrf
        ...
        var cab_option_row = 1;
            ...
            function addCabOption() {
                if(cab_option_row < 50){
                    ...
                    html   += '<td style="width:350px"><input type="text" name="cab_option['+ cab_option_row +'][content]" placeholder="Content" class="form-control cab" id="cab_content'+ cab_option_row +'" required></td>';
                    html   += '<td><input type="number" name="cab_option['+ cab_option_row +'][amount]" placeholder="Amount" class="form-control cab" id="cab_amount'+ cab_option_row +'" value="0" required></td>';
                    html   += '<td><input type="number" name="cab_option['+ cab_option_row +'][discount]" placeholder="Discount" class="form-control cab" id="cab_discount'+ cab_option_row +'" value="0" required></td>';
        ...
        function addSafariOption() {
            if (safari_option_row < 50) {
                ...
                html += '<td><input type="number" name="safari_option[' + safari_option_row +
                    ...
                    '" value="0" required></td>';
                html += '<td><input type="number" name="safari_option[' + safari_option_row +
                    '][discount]" placeholder="Discount" class="form-control safari" id="safari_discount' + safari_option_row +
                    '" value="0" required></td>';
...
<script>
    @if (isset($estimate) && in_array('flight', $estimate_type) && count($estimate->flights) > 0)
        var flight_trip_row = {{ count($estimate->flights) }};
    @else
...
function addSafari() {
   ...
   if (sanctuary == 'tadoba') {
    ...
    html ='<div class="card tadobadiv" id="safaris'+safari_row+'">';
    html +='<div class="card-header bg-dark">';
    html +='<h3 class="card-title">tadoba Corbett National Park Safari</h3>';
    html +='<div class="card-tools">';
    html +='<a href="javascript:void(0)" class="btn bg-danger btn-sm" onclick="$(\'#safaris' + safari_row + '\').remove();">Remove</a>';
    html +='</div>';
    html +='</div>';
    ...
    html +='<div class="form-group col-sm-4">';
    html +='<label for="mode' + safari_row + '">Mode of Vehicle</label>';
    html +='<select id="mode' + safari_row + '" class="form-control tadoba" name="safari[' + safari_row + '][mode]" required>';
    html +='<option value="" selected>Select Mode of Vehicle</option>';
    html +='<option value="Jeep">Jeep</option>';
    html +='<option value="Canter">Canter</option>';
    html +='</select>';
    ...
    html +='<div class="form-group col-sm-4">';
    html +='<label for="area' + safari_row + '">Safari Area</label>';
    html +='<select name="safari[' + safari_row + '][area]" class="form-control tadoba" id="area' + safari_row + '" required>';
    html +='<option value="">Select Safari Area</option>';
    html +='<option value="Moharli/Junona/Adegaon/Devada/Agarzari">Moharli/Junona/Adegaon/Devada/Agarzari</option>';
    html +='<option value="Pangadi/Pangadi Aswal Chuha/Zari/Keslaghat/Zari Peth/Mamla">Pangadi/Pangadi Aswal Chuha/Zari/Keslaghat/Zari Peth/Mamla</option>';
    html +='<option value="Kolara Chauradeo/Alizanza/Madnapur/Shirkheda">Kolara Chauradeo/Alizanza/Madnapur/Shirkheda</option>';
    html +='<option value="Navegaon/Navegaon/Nimdela">Navegaon/Navegaon/Nimdela</option>';
    html +='<option value="Moharli/Kolara">Moharli/Kolara</option>';
    html +='<option value="Mohali tour with Dangerous zone">Mohali tour with Dangerous zone</option>';
    html +='</select>';
    html +='</div>';
    html +='<div class="form-group col-sm-4">';
    html +='<label for="total_person' + safari_row + '">No of Person</label>';
    html +='<input type="number" id="total_person' + safari_row + '" class="form-control tadoba" placeholder="No of Person" name="safari[' + safari_row + '][total_person]" value="1" required>';
    html +='</div>';
    html +='<div class="form-group col-sm-4">';
    html +='<label for="nationality' + safari_row + '">Nationality</label>';
    html +='<select name="safari[' + safari_row + '][nationality]" id="nationality' + safari_row + '" class="form-control tadoba" required>';
    html +='<option value="">Select Nationality</option>';
    html +='<option value="Indian">Indian</option>';
    html +='<option value="Foreigner">Foreigner</option>';
    html +='</select>';
    ...
    html +='<div class="form-group col-sm-4">';
    html +='<label for="date' + safari_row + '">Safari Date</label>';
    html +='<input type="date" id="date' + safari_row + '" class="form-control tadoba" placeholder="Safari Date" name="safari[' + safari_row + '][date]" required>';
    html +='</div>';
    html +='<div class="form-group col-sm-4">';
    html +='<label for="tadoba_time' + safari_row + '">Time</label>';
    html +='<select name="safari[' + safari_row + '][time]" id="tadoba_time' + safari_row + '" class="form-control tadoba" required>';
    html +='<option value="">Select Time</option>';
    html +='<option value="Morning">Morning</option>';
    html +='<option value="Evening">Evening</option>';
    html +='</select>';
    ...
    html +='<div class="form-group col-sm-12">';
    html +='<label for="jeeps' + safari_row + '">No. of Jeeps/Canter</label>';
    html +='<input type="number" id="jeeps' + safari_row + '" class="form-control tadoba" placeholder="No. of Jeeps/Canter" name="safari[' + safari_row + '][jeeps]" value="1" required>';
    html +='</div>';
    html +='<div class="form-group col-sm-12">';
    html +='<label for="note' + safari_row + '">Safari Note</label>';
    html +='<textarea class="form-control tadoba summernote" id="note' + safari_row + '" name="safari[' + safari_row + '][note]"></textarea>';
    html +='</div>';
    html +='</div>';
    html +='</div>';
    html +='</div>';
