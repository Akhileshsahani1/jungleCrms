            ...
            <div class="form-group col-sm-12">
                ...
                <select id="sanctuary" class="form-control safari" name="sanctuary" onchange="loadForm()">
                    ...
                    <option value="ranthambore"
                        ...
                        Ranthambore</option>
                    <option value="tadoba"
                        {{ old('sanctuary', in_array('safari', $estimate_type) ? $estimate->safari->sanctuary : '') == 'tadoba' ? 'selected' : '' }}>
                        Tadoba</option>
                </select>
                @error('sanctuary')
...
<div id="gir">
    @include('estimates.package.sanctuaries.gir')
</div>
<div id="jim">
    @include('estimates.package.sanctuaries.jim')
</div>
<div id="ranthambore">
    @include('estimates.package.sanctuaries.ranthambore')
</div>
<div id="tadoba">
    @include('estimates.package.sanctuaries.tadoba')
</div>
