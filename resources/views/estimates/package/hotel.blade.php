...
@if (in_array('hotel', $estimate_type) && count($estimate->hotels) > 0)
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <select class="form-control hotel" name="hotel[{{ $key }}][service]"
                            id="service{{ $key }}"
                            onchange="getDestinationTotal({{ $key }}, this.value)" required>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="number" id="discount{{ $key }}" class="form-control hotel"
                            placeholder="Discount" name="hotel[{{ $key }}][discount]" value="{{ $hotel->option->discount }}" required>
                    </div>

                    <div class="form-group col-sm-6">
                        <label for="amount{{ $key }}">Amount (₹)</label>
                        <input type="number" id="amount{{ $key }}" class="form-control hotel"
                            placeholder="Amount" name="hotel[{{ $key }}][amount]" value="{{ $hotel->option->amount }}" required>
                    </div>
                    <div class="form-group col-sm-12">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-sm-4">
                    ...
                    <select class="form-control hotel" name="hotel[0][service]" id="service0"
                        onchange="getDestinationTotal(0, this.value)" required>
                        <option>Select Service</option>
                    </select>
                </div>
                <div class="form-group col-sm-6">
                    <label for="discount0">Discount (₹)</label>
                    <input type="number" id="discount0" class="form-control hotel" placeholder="Discount"
                        name="hotel[0][discount]" value="0" required>
                </div>
                <div class="form-group col-sm-6">
                    <label for="amount0">Amount (₹)</label>
                    <input type="number" id="amount0" class="form-control hotel" placeholder="Amount"
                        name="hotel[0][amount]" value="0" required>
                </div>
