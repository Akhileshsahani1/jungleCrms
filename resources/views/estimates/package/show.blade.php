...
@endisset -->
                        ...
                        @foreach ($estimate->safaris as $key => $safari)
                            <li class="nav-item">
                                <a @if ($loop->first) class="nav-link active" @else class="nav-link" @endif
                                   ...
                                   @elseif ($estimate->safari->sanctuary == 'tadoba')
                                        <h6 class="dynamic_text_color"><i class="fas fa-paw"></i> Tadoba National Park</h6>
                                    @endif
                                    ...
                                    <p class="m-0 f12 f700 dynamic_text_color">
                                        @if (in_array($estimate->safari->sanctuary, ['jim','tadoba']))
                                        ...
                                        <thead>
                                            <tr>
                                                <th colspan="2" class="card-title">
                                                    ...
                                                    @elseif ($safari->sanctuary == 'tadoba')
                                                        Tadoba National Park ({{ $safari->area }})
                                                    @endif
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            @elseif ($safari->sanctuary == 'gir')
                                             ...
                                             @elseif ($safari->sanctuary == 'tadoba')
                                                <tr>
                                                    <td><b>Destination: </b></td>
                                                    <td><span>Tadoba National Park</span></td>
                                                </tr>
                                            @endif
                                            @if (in_array($estimate->safari->sanctuary, ['jim','tadoba']))
                                                <tr>
                                            ...
                                            @elseif (in_array($estimate->safari->sanctuary, ['jim','tadoba']))
                                                <tr>
                                                    <td><b>Total Person: </b></td>
                                                    <td><span> {{ $safari->total_person }}</span></td>
                                                </tr>
            ...
            @endif
             @if (in_array('flight', $estimate_type))
                <div class="col-sm-12">
                    <ul class="nav nav-tabs card-header-tabs" id="myTabFlight" role="tablist">
                        @foreach ($estimate->flight_options as $key => $flight)
                            <li class="nav-item">
                                <a @if ($loop->first) class="nav-link active" @else class="nav-link" @endif
                                    id="{{ $key }}-tab-flight" data-toggle="tab"
                                    href="#tab-flight-{{ $key }}" role="tab"
                                    aria-controls="{{ $key }}"
                                    @if ($loop->first) aria-selected="true" @else aria-selected="false" @endif>
                                    <h6><i class="fas fa-flight"></i>
                                        {{ \Carbon\Carbon::parse($flight->travel_date)->format('d-m-Y') }}</h6>
                                    <p class="m-0 text-muted f12 f900">Type : {{ ucfirst($flight->type) }}</p>
                                    <p class="m-0 f12 f700">
                    ...
                    <div class="tab-content" id="myTabflightContent">
                        @foreach ($estimate->flight_options as $key => $flight)
                            <div class="tab-pane fade @if ($loop->first) show active @endif p-2 mt-4"
                                id="tab-flight-{{ $key }}" role="tabpanel"
                                aria-labelledby="{{ $key }}-tab-flight">
                                <div class="row">
                                    <table class="table table-striped bookdetail">
                                        <thead>
                                            <tr>
                                                <th colspan="2" class="card-title"> <i
                                                        class="fas fa-map-marker-alt"></i> {{ $flight->from }} - <i
                                                        class="fas fa-map-marker-alt"></i> {{ $flight->to }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td><b>Trip Type: </b></td>
                                                @if($estimate->flight)
                                                @if($estimate->flight->trip_type == 'one_way')
                                                <td><span> One Way </span></td>
                                                @endif
                                                @if($estimate->flight->trip_type == 'round_trip')
                                                <td><span> Round Trip </span></td>
                                                @endif
                                                @if($estimate->flight->trip_type == 'multi_city')
                                                <td><span> Multi City </span></td>
                                                @endif
                                                  @endif
                                            </tr>
                                            <tr>
                                                <td><b>Total Person: </b></td>
                                                @if($estimate->flight)
                                                <td><span> {{ (int)$estimate->flight->adults + (int)$estimate->flight->childs + (int)$estimate->flight->infants }} </span></td>
                                                @endif
                                            </tr>
                                             <tr>
                                                <td><b>Adults: </b></td>
                                                @if($estimate->flight)
                                                <td><span> {{ (int)$estimate->flight->adults }} </span></td>
                                                @endif
                                            </tr>
                                             @if($estimate->flight && $estimate->flight->childs)
                                             <tr>
                                                <td><b>Adults: </b></td>
                                               
                                                <td><span> {{ (int)$estimate->flight->childs }} </span></td>
                                                
                                            </tr>
                                            @endif
                                            @if($estimate->flight && $estimate->flight->infants)
                                             <tr>
                                                <td><b>Infants: </b></td>
                                               
                                                <td><span> {{ (int)$estimate->flight->infants }} </span></td>
                                                
                                            </tr>
                                            @endif
                                            <tr>
                                                <td><b>From : </b></td>
                                                <td><span> {{ $flight->from }}</span></td>
                                            </tr>
                                            <tr>
                                                <td><b>To : </b></td>
                                                <td><span>
                                            ...
                                            <tr>
                                                ...
                                                <td><span>{{ $flight->travel_class }}
                                                </span>
                                                </td>
                                            </tr>
                                           
                                            <tr>
                                                <td><b>Airport(from): </b></td>
                                                <td><span> {{ $flight->airport_name_from }}</span></td>
                                            </tr>
                                            <tr>
                                                <td><b>Airport(to): </b></td>
                                                <td><span>
                                                        {{ $flight->airport_name_to }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><b>Cancellation Penalty: </b></td>
                                                <td><span> {{ $flight->cancellation_charges }}</span></td>
                                            </tr>
                                            <tr>
                                                <td><b>Total Vehicle: </b></td>
                                                <td><span> {{ $flight->no_of_flight }} Vehicle</span></td>
                                            </tr>
                                            <tr>
                                                <td><b>Airline Name : </b></td>
                                                <td><span> {{ $flight->airline_name }} </span></td>
                                            </tr>
                                            <tr>
                                                <td><b>Departure Time : </b></td>
                                                <td><span>  {{ \Carbon\Carbon::parse($flight->departure_time)->format('g:i A') }}</span></td>
                                            </tr>
                                            <tr>
                                                <td><b>Reach Time : </b></td>
                                                <td><span>  {{ \Carbon\Carbon::parse($flight->reach_time)->format('g:i A') }}</span></td>
                                            </tr>
                                            @if($flight->stops)
                                            <tr>
                                                <td><b>Stops : </b></td>
                                                <td><span>  {{ $flight->stops }}</span></td>
                                            </tr>
                                            @endif
                                             <tr>
                                                <td><b>Flight Number : </b></td>
                                                <td><span> {{ $flight->flight_no }} </span></td>
                                            </tr>
                                             <tr>
                                                <td><b>Cabin Bag : </b></td>
                                                <td><span> {{ $flight->cabin_bag }} </span></td>
                                            </tr>
                                             <tr>
                                                <td><b>Bag Weight : </b></td>
                                                <td><span> {{ $flight->bag_weight }} </span></td>
                                            </tr>
                                            <tr>
                                                <td><b>Cancellation : </b></td>
                                                <td><span> {{ $flight->cancellation }} </span></td>
                                            </tr>
                                            <tr>
                                                <td><b>Meal : </b></td>
    ...
    <script>
        $('#razorpay').on('click', function(event) {
            ...
            var options = {
                ...
                // "key": key,
                "key_secret": "1N83Y5McnjXxDneX0GGLK0Cm",
                "key": "rzp_test_S5UgYk20dsOfUk",
