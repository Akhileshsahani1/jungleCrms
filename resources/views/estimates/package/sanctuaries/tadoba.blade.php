...
<div class="card" id="safaris{{ $key }}">
    <div class="card-header bg-dark">
        <h3 class="card-title">Tadoba National Park Safari</h3>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-sm-12">
                ...
                <textarea class="form-control tadoba summernote" id="note{{ $key }}" name="safari[{{ $key }}][note]">{{ $safari->note }}</textarea>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="form-group col-sm-4">
                ...
                <select id="mode0" class="form-control tadoba" name="safari[0][mode]"  required>
                    <option value="" selected>Select Mode of Vehicle</option>
            ...
            <div class="form-group col-sm-12">
                ...
                <textarea class="form-control tadoba summernote" id="note0" name="safari[0][note]"></textarea>
            </div>
        </div>
    </div>
</div>
