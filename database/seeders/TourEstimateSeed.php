...
class TourEstimateSeed extends Seeder
{
    /**
        ...
        foreach ($customers as $customer) {
            ...
            if ($destination == "Ranthambore National Park") {
                for ($i = 0; $i < 2; $i++) {
                    ...
                    $hotell_option                                 = new EstimateHotelOption();
                    ...
                    $hotell_option->accepted                        = $i == 0 ? 'yes' : 'no';
            ...
            $terms                              = Term::where('mode', 'estimate')->where('type', 'tour')->where('filter', $sanctuary)->get();
