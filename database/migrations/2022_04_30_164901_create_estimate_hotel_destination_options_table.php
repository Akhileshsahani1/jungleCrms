...
class CreateEstimateHotelDestinationOptionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('estimate_hotel_destination_options', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('destination_id')->nullable();
            $table->foreign('destination_id')->references('id')->on('estimate_hotel_destinations')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('estimate_hotel_destination_options');
    }
}
